...
namespace Kafka.io
{
	...
	{
		public static global::Avro.Schema _SCHEMA = global::Avro.Schema.Parse("{\"type\":\"record\",\"name\":\"Curso\",\"namespace\":\"Kafka.io\",\"fields\":[{\"name\":\"Id\",\"ty" +
				"pe\":\"string\"},{\"name\":\"Descricao\",\"type\":\"string\"}]}");
		private string _Id;
